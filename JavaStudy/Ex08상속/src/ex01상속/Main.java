...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * 클래스명 앞에 final이라고 적혀 있으면 이 클래스는 최종수정이 되면 안되는 클래스를 의미
		 * 상속이 불가능함
		 * 
		 * 프로그래밍에서는 상속을 단순히 물려받는거에 그치는게 아니라
		 * 물려받은 후 자식클래스에 특성에 맞게 확장시키는 개념으로 생각한다
		 * 
		 * 자바의 상속을 할때는 extends라는 키워드를 사용한다
		 * 
		 * 부모 클래스를 Super Class라고 부르며
		 * 자식 클래스를 Sub Class라고 부른다
		 *
		 * 상속의 특징
		 * 1.동시에 두개이상의 상속을 받을 수 없다
